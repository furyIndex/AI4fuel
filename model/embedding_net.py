    ...
    def forward(self, embeddings, labels):
        ...
        for i in range(batch_size):
            ...
            if valid_negatives.numel() > 0:
                ...
                num_select = min(5, len(valid_negatives))
                selected_indices = torch.randperm(len(valid_negatives))[:num_select]
                selected_js = valid_negatives[selected_indices]
                mask[i, selected_js] = 1.0
